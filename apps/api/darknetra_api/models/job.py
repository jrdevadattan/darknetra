...
JOB_STATE_ENUM = sa.Enum(JobState, name="job_state")


class Job(Base):
    """Authoritative PostgreSQL record for an asynchronous task.

    Redis/Celery carries delivery only. The row survives broker flushes and is
    the source of truth for investigator-visible processing status.
    """
