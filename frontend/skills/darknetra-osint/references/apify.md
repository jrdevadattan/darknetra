...
The returned JSON includes the requested/final URL, retrieval time, run/build identifiers, backup reason, a SHA-256 of the returned text and any preliminary usage figure. The page is recorded in the activity timeline and evidence graph using the existing helper result contract. Text is capped at 16,000 characters and truncation is labelled. Preserve source attribution and treat page statements as unverified until corroborated.
